<section class="w-1/3 m-auto">
    ...
    <form method="post" action="#" class="bg-gray-800 p-8 mt-4 rounded-lg">
        ...
        <label for="password" class="text-sm mb-2 inline-block w-full">
            <input type="password" name="password" placeholder="Mot de passe" class="w-full bg-transparent focus:outline-none border-b border-solid border-white p-1" autocomplete="off">
        </label>
